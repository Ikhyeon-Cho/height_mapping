...
private:
  ...
  // Topics
  std::string heightmap_topic_{ pnh_.param<std::string>("heightMapTopic", "elevation_grid") };
  ...
  // ROS
  ros::Publisher pub_heightmap_{ pnh_.advertise<grid_map_msgs::GridMap>(heightmap_topic_, 1) };
