...
private:
  ...
  griddedFilterWithMaxHeight(const pcl::PointCloud<Laser>::Ptr &cloud,
                             float gridSize);
  pcl::PointCloud<Laser>::Ptr
  raycastFiltering(const pcl::PointCloud<Laser>::Ptr &cloud);
  ...
  pcl::PointCloud<Laser>::Ptr mergedCloud_;
};